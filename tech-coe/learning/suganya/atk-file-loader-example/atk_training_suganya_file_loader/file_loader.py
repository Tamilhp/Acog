...
class FunctionLoader(object):
    ...
    def __init__(self, path_list:List[str] = None):
        if path_list is None:
            path_list = ["/home/acog/tech-coe/projects/learning/suganya/atk-file-loader-example/tests"]
        self.function_list={}
    ...
    def apply_function(self, function_name, record: str):
        exec_function = self.get_function(function_name)
        if exec_function is not None:
            return self.function_list.get(function_name)(record)
        return record